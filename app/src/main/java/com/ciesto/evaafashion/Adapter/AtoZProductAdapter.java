...
public class AtoZProductAdapter extends RecyclerView.Adapter<AtoZProductAdapter.Myviewhoider>
{

    Context context;
    List<MerchantDetailsModel.Product> productslist;
    String MerchantId;

    public AtoZProductAdapter(Context activity, List<MerchantDetailsModel.Product> products,String Merchantid) {
    ...
    {
        final MerchantDetailsModel.Product bean=productslist.get(position);
