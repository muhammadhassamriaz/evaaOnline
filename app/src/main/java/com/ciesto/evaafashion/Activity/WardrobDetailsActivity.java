...
public class WardrobDetailsActivity extends BaseActivity {

    protected ImageView imgFeature;
    protected CircularImageView imgUser;
    protected TextView tvUsername;
    protected TextView tvWardrobe;
    protected TextView tvBio;
    protected TextView tvDes;
    protected LinearLayout lnrDes;
    protected RecyclerView rvProduct;
    protected TextView tvNodata;
    protected RecyclerView rvBottom;
    protected FrameLayout frmProduct;
    ...
    Activity activity = WardrobDetailsActivity.this;
    String MerchantId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_wardrob_details);
    ...
    private void initComponent() {
        ...
        tvBio.setTextColor(getResources().getColor(R.color.colorGrey));
        tvWardrobe.setTextColor(getResources().getColor(R.color.colorBlack));
        lnrDes.setVisibility(View.GONE);
        frmProduct.setVisibility(View.VISIBLE);
    ...
    private void SetListener() {
        tvBio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tvBio.setTextColor(getResources().getColor(R.color.colorBlack));
                tvWardrobe.setTextColor(getResources().getColor(R.color.colorGrey));
                lnrDes.setVisibility(View.VISIBLE);
                frmProduct.setVisibility(View.GONE);
            }
        });

        tvWardrobe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tvBio.setTextColor(getResources().getColor(R.color.colorGrey));
                tvWardrobe.setTextColor(getResources().getColor(R.color.colorBlack));
        ...
        call.enqueue(new Callback<MerchantDetailsModel>() {
            ...
            public void onResponse(Call<MerchantDetailsModel> call, Response<MerchantDetailsModel> response) {
                ...
                if (response.body().getStatus().equals("1")) {
                    ...
                    if (!response.body().getMerchant().getProfileImage().equalsIgnoreCase("")) {
                        Glide.with(activity)
                    ...
                    if (!response.body().getMerchant().getCoverImage().equalsIgnoreCase("")) {

                        Glide.with(activity)
                                .load(Constant.Profile_Images + response.body().getMerchant().getCoverImage())
                                .apply(options)
                                .thumbnail(Glide.with(activity).load(R.drawable.loader))
                                .into(imgFeature);
                    }
