...
public class OrderHistroyActivity extends BaseActivity {

    Activity activity=OrderHistroyActivity.this;
    ...
    public void GetOrder()
    {
        ...
        Call<PandingOrderModel> call = apiService.GetPandingOrder(Constant.ACCESSKEY,loginPreferences.getUserID(),"1");
